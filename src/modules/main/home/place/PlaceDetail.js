                ...
                <View style={styles.container}>
                    <View style={styles.imageBox}>
                        <View style={styles.backButton}>
                            <Icon onPress={() => this.props.navigation.goBack()} size={40} color={Colors.APP_MAIN}
                                  name={'chevron-left'}/>
                        </View>
                    ...
                    <View style={styles.nameBox}>
                        ...
                        <View style={styles.reactionBox}>
                            ...
                            <View>
                                <Button onPress={() => ToastAndroid.show("Đã thêm vào mục quan tâm", ToastAndroid.LONG)}
                                        type={"outline"} buttonStyle={{borderColor: Colors.APP_MAIN, borderWidth: 1}}
