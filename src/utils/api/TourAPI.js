...
export const getTopRecommendedTours = async (typeID) => {
    try {
        console.log("========Get Recommended Tours by Type=========")
        console.log(typeID)
...
export const getToursByType = async (typeID) => {
    try {
        console.log("========Get Tours by Type=========")
        console.log(typeID)
