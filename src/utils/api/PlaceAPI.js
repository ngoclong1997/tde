...
export const getTopRecommendedPlaces = async (typeID) => {
    try {
        console.log("========Get Recommended Places by Type=========")
        console.log(typeID)
...
export const getPlacesByType = async (typeID) => {
    try {
        console.log("========Get Places by Type=========")
        console.log(typeID)
