...
export const getTopRecommendedRestaurants = async (typeID) => {
    try {
        console.log("========Get Recommended Restaurants by Type=========")
        console.log(typeID)
...
export const getRestaurantsByType = async (typeID) => {
    try {
        console.log("========Get Restaurants by Type=========")
        console.log(typeID)
