...
export const getTopRecommendedHotDeals = async (typeID) => {
    try {
        console.log("========Get Recommended HotDeals by Type=========")
        console.log(typeID)
...
export const getHotDealsByType = async (typeID) => {
    try {
        console.log("========Get HotDeals by Type=========")
        console.log(typeID)
